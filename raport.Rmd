...
* **Wskaźnik rotacji aktywów (produktywność aktywów)** jest na imponującym poziomie (2.2) i lepszym niż konkurencja. Pokazuje efektywność wykorzystania aktywów tworzących wartość sprzedaży.
...
* **Wskaźnik rentowności sprzedaży netto** jest znacznie wyższy niż konkurencja. W 2019 roku...

* **Marża zysku netto** jest 2 razy wyższa niż konkurencja, i pokazuje wyższą rentowność sprzedaży.

* **Zwrot z aktywów (ROA)**
Wskaźnik odzwierciedla rentowność majątku
